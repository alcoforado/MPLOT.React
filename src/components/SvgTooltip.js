...
var SvgToolTip = /** @class */ (function (_super) {
    ...
    SvgToolTip.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { ref: function (node) { return _this.setNode(node); }, style: { top: 0, opacity: 0, position: "absolute", "pointerEvents": "none", "boxSizing": "border-box" } }, this.props.children));
        //return (<div ></div>)
    };
    return SvgToolTip;
}(React.Component));
