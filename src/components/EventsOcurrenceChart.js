System.register(["react", "d3", "./SvgTooltip", "../extensions/ColorGenerator", "./PieChart3D", "../extensions/extensions"], function (exports_1, context_1) {
    "use strict";
    ...
    var react_1, d3, SvgTooltip_1, ColorGenerator_1, PieChart3D_1, Extensions, EventsOcurrenceChart;
    return {
        setters: [
            function (react_1_1) {
                react_1 = react_1_1;
            ...
            function (ColorGenerator_1_1) {
                ColorGenerator_1 = ColorGenerator_1_1;
            },
            function (PieChart3D_1_1) {
                PieChart3D_1 = PieChart3D_1_1;
            },
            ...
            EventsOcurrenceChart = /** @class */ (function (_super) {
                ...
                EventsOcurrenceChart.prototype.render = function () {
                    ...
                    return (react_1.default.createElement("div", { id: "main" },
                        react_1.default.createElement("svg", { id: this.svgId, width: 2100, ref: function (node) { return _this.svgNode = node; }, height: 500 }),
                        react_1.default.createElement(SvgTooltip_1.SvgToolTip, { ref: function (tip) { return _this.tip = tip; }, svgNodeId: this.svgId },
                            react_1.default.createElement("div", { className: "tooltip-title" },
                                "On ",
                                this.state.dateTip.toDateString()),
                            react_1.default.createElement("div", { className: "container-panel-side-by-side" },
                                react_1.default.createElement("div", { className: "panel-side-by-side" }, this.state.errorsTip.map(function (value, i) {
                                    return (react_1.default.createElement("div", { className: "vertical-space-small" },
                                        react_1.default.createElement("div", { style: { backgroundColor: value.Color }, className: "div-bullet" }),
                                ...
                                react_1.default.createElement("div", { className: "vertical-blur-separator" }, " "),
                                react_1.default.createElement("div", { className: "panel-side-by-side" },
                                    react_1.default.createElement(PieChart3D_1.PieChart3D, { data: this.state.errorsTip, excentricity: 0.8, width: pieSize, height: pieSize, height3D: 0.1 * pieSize })))),
                        react_1.default.createElement("h1", null, "Error Dictionary"),
                        react_1.default.createElement("table", null,
                            react_1.default.createElement("tbody", null, this.state.errDict.map(function (elem) {
                                return react_1.default.createElement("tr", null,
                                    react_1.default.createElement("td", null, elem.Name),
                                    react_1.default.createElement("td", null, elem.Value));
                            })))));
                };
